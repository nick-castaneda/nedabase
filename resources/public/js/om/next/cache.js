...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__16014 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__16015 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__16015,x_SINGLEQUOTE__16014,this$){
return (function (p1__16013_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__16013_SHARP_,id_SINGLEQUOTE__16015),id,x_SINGLEQUOTE__16014);
});})(id_SINGLEQUOTE__16015,x_SINGLEQUOTE__16014,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__16014);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__15401__auto__,writer__15402__auto__,opt__15403__auto__){
return cljs.core._write.call(null,writer__15402__auto__,"om.next.cache/Cache");
});
